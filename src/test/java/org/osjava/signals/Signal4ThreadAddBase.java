...
public class Signal4ThreadAddBase extends SignalThreadBase {

	protected Signal4<Boolean, String, Integer, Integer> signal;
	...
	private void testAddingWithMultipleThreads(final int threadCount, final boolean isOnce)
		...
		Callable<Integer> task = new Callable<Integer>() {
			public Integer call() throws Exception {
				SignalListener4<Boolean, String, Integer, Integer> listener =
						new SignalListener4<Boolean, String, Integer, Integer>() {
