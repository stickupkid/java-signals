...
public class Signal5ThreadAddBase extends SignalThreadBase {

	protected Signal5<Boolean, String, Integer, Integer, String> signal;
	...
	private void testAddingWithMultipleThreads(final int threadCount, final boolean isOnce)
		...
		Callable<Integer> task = new Callable<Integer>() {
			public Integer call() throws Exception {
				SignalListener5<Boolean, String, Integer, Integer, String> listener =
						new SignalListener5<Boolean, String, Integer, Integer, String>() {
