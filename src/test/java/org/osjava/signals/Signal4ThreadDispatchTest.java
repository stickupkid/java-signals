...
public class Signal4ThreadDispatchTest extends SignalThreadTest {
	...
	private void testDispatchWithMultipleThreads(final int threadCount, final boolean isOnce)
		...
		Callable<Integer> task = new Callable<Integer>() {
			public Integer call() throws Exception {
				final SignalListener4<Integer, Integer, Integer, Integer> listener = new SignalListener4<Integer, Integer, Integer, Integer>() {

					@Override
					public void apply(Integer value0, Integer value1, Integer value2, Integer value3) {
