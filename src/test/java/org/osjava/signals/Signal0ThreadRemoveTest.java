...
public class Signal0ThreadRemoveTest extends SignalThreadTest {
	...
	@Test
	public void test_adding_two_listeners_in_two_threads_and_removing()
			throws InterruptedException, ExecutionException {
		testRemoveWithMultipleThreads(2);
	}
	
	@Test
	public void test_adding_three_listeners_in_three_threads_and_removing()
			throws InterruptedException, ExecutionException {
		testRemoveWithMultipleThreads(3);
	}
	
	@Test
	public void test_adding_four_listeners_in_four_threads_and_removing()
			throws InterruptedException, ExecutionException {
		testRemoveWithMultipleThreads(4);
	}

	@Test
	public void test_adding_eight_listeners_in_eight_threads_and_removing()
			throws InterruptedException, ExecutionException {
	...
	private void testRemoveWithMultipleThreads(final int threadCount) throws InterruptedException,
			ExecutionException {
