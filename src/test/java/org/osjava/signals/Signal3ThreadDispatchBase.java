...
public class Signal3ThreadDispatchBase extends SignalThreadBase {

	protected Signal3<Integer, Integer, Integer> signal;
	...
	private void testDispatchWithMultipleThreads(final int threadCount, final boolean isOnce)
		...
		Callable<Integer> task = new Callable<Integer>() {
			public Integer call() throws Exception {
				final SignalListener3<Integer, Integer, Integer> listener =
						new SignalListener3<Integer, Integer, Integer>() {
