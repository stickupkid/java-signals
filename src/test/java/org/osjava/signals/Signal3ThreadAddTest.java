 ...
 */
public class Signal3ThreadAddTest extends SignalThreadTest {

	private Signal3<Boolean, String, Integer> signal;
	...
	private void testAddingWithMultipleThreads(final int threadCount, final boolean isOnce)
		...
		Callable<Integer> task = new Callable<Integer>() {
			public Integer call() throws Exception {
				SignalListener3<Boolean, String, Integer> listener = new SignalListener3<Boolean, String, Integer>() {
