...
public class Signal5ThreadDispatchBase extends SignalThreadBase {

	protected Signal5<Integer, Integer, Integer, Integer, Integer> signal;
	...
	private void testDispatchWithMultipleThreads(final int threadCount, final boolean isOnce)
		...
		Callable<Integer> task = new Callable<Integer>() {
			public Integer call() throws Exception {
				final SignalListener5<Integer, Integer, Integer, Integer, Integer> listener =
						new SignalListener5<Integer, Integer, Integer, Integer, Integer>() {
