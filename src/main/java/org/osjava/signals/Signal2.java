 ...
 * Date: 16/09/2011
 */
public interface Signal2<A, B, SlotType extends Slot, SignalListenerType extends Signal2.SignalListener2>
        extends Signal<SlotType, SignalListenerType>
{
    ...
    public interface SignalListener2<A, B>
